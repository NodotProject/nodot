...
func test_mesh_generation():
	...
	expect_not_null(
		preview_meshes[0].material_override, "Preview mesh should have material override"
	)
...
func test_transparency_setting():
	...
	expect_equal(
		preview_mesh.material_override.albedo_color.a, 0.3, "Should set transparency correctly"
	)
...
func test_color_tint_setting():
	...
	expect_approximately_equal(
		material_color.r, Color.RED.r, 0.01, "Should set red component correctly"
	)
	expect_approximately_equal(
		material_color.g, Color.RED.g, 0.01, "Should set green component correctly"
	)
	expect_approximately_equal(
		material_color.b, Color.RED.b, 0.01, "Should set blue component correctly"
	)
