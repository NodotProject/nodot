...
## Fires a one-shot animation. The friendly_name is the path to the OneShot node.
...
## Aborts a one-shot animation. The friendly_name is the path to the OneShot node.
...
## Returns true if a one-shot animation is currently active. The friendly_name is the path to the OneShot node.
