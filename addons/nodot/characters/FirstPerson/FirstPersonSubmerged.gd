...
@onready var camera: Camera3D = parent.camera
@onready var keyboard_input: FirstPersonKeyboardInput = parent.keyboard_input
@onready var default_gravity: float = parent.gravity
@onready var default_speed: float = keyboard_input.speed
